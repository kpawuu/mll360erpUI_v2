  ...
  <ul class="space-y-4">
    ...
    <li>
      <button
        ...
        aria-controls="dropdown-company-settings"
        data-collapse-toggle="dropdown-company-settings"
      >
        <svg
          class="w-[24px] h-[24px] text-gray-800 dark:text-white"
          aria-hidden="true"
        ...
        <span class="flex-1 ml-3 text-left whitespace-nowrap">Company</span>
        <svg
          aria-hidden="true"
          class="w-6 h-6"
          fill="currentColor"
      ...
      <ul id="dropdown-company-settings" class="hidden py-2 space-y-2">
        <li>
          ...
          >
            <svg
              class="w-6 h-6 mr-3 text-gray-400 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
    ...
    <li>
      <button
        type="button"
        class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
        aria-controls="dropdown-entity-settings"
        data-collapse-toggle="dropdown-entity-settings"
      >
        <svg
          class="w-[24px] h-[24px] text-gray-800 dark:text-white"
          aria-hidden="true"
    ...
    <li>
      <button
        type="button"
        class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
        aria-controls="dropdown-user-settings"
        data-collapse-toggle="dropdown-user-settings"
      >
        <svg
          class="w-[24px] h-[24px] text-gray-800 dark:text-white"
          aria-hidden="true"
      ...
      <ul id="dropdown-user-settings" class="hidden py-2 space-y-2">
        ...
        <li>
          <router-link
            to="/settings/user-role-assignment"
            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
          >
            <svg
              class="w-6 h-6 mr-3 text-gray-400 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
    ...
    <li>
      <button
        type="button"
        class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
        aria-controls="dropdown-crm-settings"
        data-collapse-toggle="dropdown-crm-settings"
      >
        <svg
          class="w-[24px] h-[24px] text-gray-800 dark:text-white"
          aria-hidden="true"
      ...
      <ul id="dropdown-crm-settings" class="hidden py-2 space-y-2">
        <li>
          <router-link
    ...
    <li>
      <button
        type="button"
        class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
        aria-controls="dropdown-system-settings"
        data-collapse-toggle="dropdown-system-settings"
      >
        <svg
          class="w-[24px] h-[24px] text-gray-800 dark:text-white"
          aria-hidden="true"
