  ...
  <div class="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300">
                            {{ filteredPackageTypes.length }} types
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            <span class="text-sm text-gray-600 dark:text-gray-400">
                                Found {{ filteredPackageTypes.length }} result{{ filteredPackageTypes.length !== 1 ? 's' : '' }}
                            </span>
                            <button 
                                @click="clearFilters"
    ...
    <div v-if="packageTypeStore.loading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="n in 6" :key="n" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 animate-pulse">
        ...
        <div v-else>
            <!-- Empty State -->
            <div v-if="filteredPackageTypes.length === 0" class="flex flex-col items-center justify-center py-20">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-center max-w-md mb-8 text-lg">
                    {{ searchQuery ? 'Try adjusting your search criteria or clear the filters.' : 'Get started by adding your first package type to organize your operations.' }}
                </p>
            ...
            <div v-else-if="viewMode === 'grid'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div v-for="packageType in filteredPackageTypes" :key="packageType.id" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-gray-300 dark:hover:border-gray-500 transition-colors duration-200">
        <div class="flex justify-between items-start mb-4">
