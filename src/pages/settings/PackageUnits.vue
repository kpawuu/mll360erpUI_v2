  ...
  <div class="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300">
                            {{ filteredPackageUnits.length }} units
                        </span>
                    </div>
                </div>
            </div>
          ...
          <input 
            ...
            type="text" 
                                placeholder="Search by unit name, description, or package type..."
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            <span class="text-sm text-gray-600 dark:text-gray-400">
                                Found {{ filteredPackageUnits.length }} result{{ filteredPackageUnits.length !== 1 ? 's' : '' }}
                            </span>
                            <button 
                                @click="clearFilters"
    ...
    <div v-if="packageUnitStore.loading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="n in 6" :key="n" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 animate-pulse">
        ...
        <div v-else>
            <!-- Empty State -->
            <div v-if="filteredPackageUnits.length === 0" class="flex flex-col items-center justify-center py-20">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-center max-w-md mb-8 text-lg">
                    {{ searchQuery ? 'Try adjusting your search criteria or clear the filters.' : 'Get started by adding your first package unit to organize your operations.' }}
                </p>
            ...
            <div v-else-if="viewMode === 'grid'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div v-for="packageUnit in filteredPackageUnits" :key="packageUnit.id" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-gray-300 dark:hover:border-gray-500 transition-colors duration-200">
        <div class="flex justify-between items-start mb-4">
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="text-gray-900 dark:text-white font-medium">{{ packageUnit.type }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-500 dark:text-gray-400">Package Type:</span>
                            <span class="text-gray-900 dark:text-white font-medium">{{ packageUnit.package_type?.type || 'N/A' }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
              ...
              <option v-for="packageType in packageTypes" :key="packageType.id" :value="packageType.id">
                {{ packageType.type }}
                  ...
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Choose the package type this unit belongs to.
                  </p>
          </div>
