<template>
    <div class="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Entity Groups Management</h1>
                    <p class="text-gray-600 dark:text-gray-400 text-lg">Organize entities into logical groups (clients, suppliers, etc.)</p>
                </div>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Search & Filter Groups</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Find and manage your entity groups</p>
                        </div>
                    </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div class="lg:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Search Groups</label>
                        <div class="relative">
                            ...
                            >
                            <div v-if="entityGroupStore.loading" class="absolute inset-y-0 right-0 flex items-center pr-4">
                    ...
                    <div class="flex items-end space-x-3">
                        ...
                        >
                            <div v-if="entityGroupStore.loading" class="animate-spin rounded-full h-4 w-4 border-2 border-white border-t-transparent mr-2"></div>
            ...
            <div v-for="n in 6" :key="n" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 animate-pulse">
                ...
                <div class="flex justify-between items-start mb-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            <div class="h-6 bg-gray-300 dark:bg-gray-600 rounded w-36 mb-2"></div>
                ...
                <div class="flex space-x-2">
                    <div class="flex-1 h-10 bg-gray-300 dark:bg-gray-600 rounded-lg"></div>
                    <div class="flex-1 h-10 bg-gray-300 dark:bg-gray-600 rounded-lg"></div>
                </div>
            </div>
        </div>
        ...
        <div v-else>
            ...
            <div v-if="viewMode === 'grid'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div v-for="group in filteredGroups" :key="group.id" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-gray-300 dark:hover:border-gray-500 transition-colors duration-200">
                    <div class="flex justify-between items-start mb-4">
                        <div class="flex items-center">
                            <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center mr-3">
                                <span class="text-sm font-bold text-white">{{ group.group_name.charAt(0).toUpperCase() }}</span>
                            </div>
                            <div>
                        ...
                        <div class="flex space-x-1">
                            <button @click="viewEntities(group)" class="p-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                            </button>
                            <button @click="editGroup(group)" class="p-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                            </button>
                            <button @click="deleteGroup(group.id)" class="p-1 text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 rounded transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="text-gray-900 dark:text-white font-medium">{{ formatDate(group.date_created) }}</span>
                        </div>
                        <div v-if="group.date_updated" class="flex justify-between text-sm">
                            <span class="text-gray-500 dark:text-gray-400">Updated:</span>
                            <span class="text-gray-900 dark:text-white font-medium">{{ formatDate(group.date_updated) }}</span>
                        </div>
                    </div>

                    <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 mb-4">
                        <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">{{ group.group_description || 'No description available' }}</p>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
                                <span class="text-lg font-bold text-white">{{ group.group_name.charAt(0).toUpperCase() }}</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ group.group_name }}</h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ group.group_description || 'No description available' }}</p>
                        ...
                        <form @submit.prevent="saveGroup">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Basic information about the entity group.</p>
                                </div>
    ...
    <!-- View Entities Modal -->
    <div v-if="showEntitiesModal && selectedGroup" class="fixed top-0 left-0 right-0 z-60 flex items-center justify-center w-full h-full p-4 overflow-x-hidden overflow-y-auto backdrop-blur-sm bg-gray-900/70 dark:bg-gray-900/80">
        <div class="relative w-full max-w-6xl max-h-full">
            <div class="relative bg-white rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-t-xl">
                    ...
                    <button @click="showEntitiesModal = false" class="text-white bg-transparent hover:bg-white/20 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center transition-colors">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 14 14">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                        </svg>
                    </button>
                ...
                <div class="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                    <!-- Group Header -->
                    <div class="flex items-center space-x-4 p-6 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-700 dark:to-blue-900 rounded-xl">
                        <div class="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
                            <span class="text-2xl font-bold text-white">{{ selectedGroup.group_name.charAt(0).toUpperCase() }}</span>
                        </div>
                        <div class="flex-1">
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ selectedGroup.group_name }}</h2>
                            <p class="text-blue-600 dark:text-blue-400 font-medium">{{ groupEntities.length }} entities</p>
                    ...
                    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div v-for="entity in groupEntities" :key="entity.id" class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-gray-300 dark:hover:border-gray-500 transition-colors duration-200">
                            <div class="p-6">
                                <!-- Entity Header -->
    ...
    <div v-if="showEntityDetailsModal && selectedEntity" class="fixed top-0 left-0 right-0 z-60 flex items-center justify-center w-full h-full p-4 overflow-x-hidden overflow-y-auto backdrop-blur-sm bg-gray-900/70 dark:bg-gray-900/80">
        <div class="relative w-full max-w-4xl max-h-full">
            <div class="relative bg-white rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-800">
                <!-- Modal header -->
                <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-t-xl">
                    ...
                    <button @click="showEntityDetailsModal = false" class="text-white bg-transparent hover:bg-white/20 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center transition-colors">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 14 14">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                        </svg>
                    </button>
    ...
    <!-- Error Modal -->
    <div v-if="entityGroupStore.error" class="fixed top-0 left-0 right-0 z-70 flex items-center justify-center w-full h-full p-4 overflow-x-hidden overflow-y-auto backdrop-blur-sm bg-gray-900/70 dark:bg-gray-900/80">
        <div class="relative w-full max-w-md">
            <div class="relative bg-white rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-lg">{{ entityGroupStore.error }}</p>
                </div>
                <div class="flex justify-center p-6 border-t border-gray-200 dark:border-gray-700">
                    <button 
                        @click="entityGroupStore.clearError()" 
                        class="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 rounded-lg transition-all duration-200"
                    >
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                        </svg>
...
const clearSearch = async () => {
    searchQuery.value = ''
    entityGroupStore.setPage(1) // Reset to first page
    await loadEntityGroups()
}
